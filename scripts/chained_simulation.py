...
def pop_model_chained(
    ...
    time_of_m_change=None,
        ...
        part1_replicates = msprime.simulate(Ne = Ne,
            ...
            length = length,
            end_time = time_of_m_change, ## This simulation ends at time_of_m_change.
...
parser.add_argument("-m", type = float, metavar = "four_mN", required = False, default=1.0, help = "The scaled per-generation migration rate for the proximal part of the simulation (t=0 to t=t_m_change).")
parser.add_argument("-m2", type = float, metavar = "four_mN_2", required = False, default=1.0, help = "The scaled per-generation migration rate for the distal part of the simulation (t=t_m_change to end).")
...
## Set the migration matrix for the first part of the simulation (t=0 to t=1500/2*Ne)
m = four_mN/(4*Ne)
md = 0 ## Diagonal migration rate. Set to 0 for no diagonal migration.
...
## Set the migration matrix for the second part of the simulation (t=1500/2*Ne to end)
m2 = four_mN_2/(4*Ne)
md2 = 0 ## Diagonal migration rate. Set to 0 for no diagonal migration.
migration_matrix2 = [
##   P    P    P    P    P    P    P    P    P
##   o    o    o    o    o    o    o    o    o
##   p    p    p    p    p    p    p    p    p
##   1    2    3    4    5    6    7    8    9
    [0,   m2,  0,   m2,  md2, 0,   0,   0,   0],    # Pop1
    [m2,  0,   m2,  md2, m2,  md2, 0,   0,   0],    # Pop2
    [0,   m2,  0,   0,   md2, m2,  0,   0,   0],    # Pop3
    [m2,  md2, 0,   0,   m2,  0,   m2,  md2, 0],    # Pop4
    [md2, m2,  md2, m2,  0,   m2,  md2, m2,  md2],   # Pop5
    [0,   md2, m2,  0,   m2,  0,   0,   md2, m2],    # Pop6
    [0,   0,   0,   m2,  md2, 0,   0,   m2,  0],    # Pop7
    [0,   0,   0,   md2, m2,  md2, m2,  0,   m2],    # Pop8
    [0,   0,   0,   0,   md2, m2,  0,   m2,  0]]    # Pop9

trees=pop_model_chained(
